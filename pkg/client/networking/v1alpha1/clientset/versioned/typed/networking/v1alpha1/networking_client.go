...
import (
	...
	"github.com/upmio/dbscale-kube/pkg/client/networking/v1alpha1/clientset/versioned/scheme"
...
// NetworkingV1alpha1Client is used to interact with features provided by the networking.upm.io group.
...
func (c *NetworkingV1alpha1Client) NetworkClaims() NetworkClaimInterface {
	return newNetworkClaims(c)
}
