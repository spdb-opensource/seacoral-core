...
var networksResource = schema.GroupVersionResource{Group: "networking.upm.io", Version: "v1alpha1", Resource: "networks"}

var networksKind = schema.GroupVersionKind{Group: "networking.upm.io", Version: "v1alpha1", Kind: "Network"}
