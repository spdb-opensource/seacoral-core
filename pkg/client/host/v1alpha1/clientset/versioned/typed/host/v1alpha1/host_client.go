...
import (
	...
	"github.com/upmio/dbscale-kube/pkg/client/host/v1alpha1/clientset/versioned/scheme"
...
// HostV1alpha1Client is used to interact with features provided by the host.upm.io group.
type HostV1alpha1Client struct {
	restClient rest.Interface
}

func (c *HostV1alpha1Client) Hosts() HostInterface {
	return newHosts(c)
}
...
func NewForConfig(c *rest.Config) (*HostV1alpha1Client, error) {
	...
	return &HostV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new HostV1alpha1Client for the given config and
