...
import (
	...
	scheme "github.com/upmio/dbscale-kube/pkg/client/host/v1alpha1/clientset/versioned/scheme"
...
func newHosts(c *HostV1alpha1Client) *hosts {
	return &hosts{
		client: c.RESTClient(),
	}
}
...
func (c *hosts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Host, err error) {
...
func (c *hosts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HostList, err error) {
...
func (c *hosts) Create(ctx context.Context, host *v1alpha1.Host, opts v1.CreateOptions) (result *v1alpha1.Host, err error) {
	result = &v1alpha1.Host{}
	err = c.client.Post().
		Resource("hosts").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *hosts) Update(ctx context.Context, host *v1alpha1.Host, opts v1.UpdateOptions) (result *v1alpha1.Host, err error) {
	result = &v1alpha1.Host{}
	err = c.client.Put().
		Resource("hosts").
		Name(host.Name).
...
func (c *hosts) UpdateStatus(ctx context.Context, host *v1alpha1.Host, opts v1.UpdateOptions) (result *v1alpha1.Host, err error) {
	result = &v1alpha1.Host{}
	err = c.client.Put().
		Resource("hosts").
		Name(host.Name).
...
func (c *hosts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Host, err error) {
	result = &v1alpha1.Host{}
