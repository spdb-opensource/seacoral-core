...
import (
	...
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/networkpolicy"

	"github.com/upmio/dbscale-kube/dashboard_backend/handler/parser"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/customresourcedefinition/types"

	"github.com/upmio/dbscale-kube/dashboard_backend/plugin"
	...
	"github.com/upmio/dbscale-kube/dashboard_backend/api"
	...
	"github.com/upmio/dbscale-kube/dashboard_backend/errors"
	"github.com/upmio/dbscale-kube/dashboard_backend/integration"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/clusterrole"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/clusterrolebinding"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/common"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/configmap"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/container"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/controller"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/cronjob"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/customresourcedefinition"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/daemonset"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/dataselect"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/deployment"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/event"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/horizontalpodautoscaler"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/ingress"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/job"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/logs"
	ns "github.com/upmio/dbscale-kube/dashboard_backend/resource/namespace"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/node"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/persistentvolume"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/persistentvolumeclaim"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/pod"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/replicaset"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/replicationcontroller"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/role"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/rolebinding"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/secret"
	resourceService "github.com/upmio/dbscale-kube/dashboard_backend/resource/service"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/serviceaccount"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/statefulset"
	"github.com/upmio/dbscale-kube/dashboard_backend/resource/storageclass"
	"github.com/upmio/dbscale-kube/dashboard_backend/scaling"
	"github.com/upmio/dbscale-kube/dashboard_backend/settings"
	settingsApi "github.com/upmio/dbscale-kube/dashboard_backend/settings/api"
	"github.com/upmio/dbscale-kube/dashboard_backend/systembanner"
	"github.com/upmio/dbscale-kube/dashboard_backend/validation"
)
...
func CreateHTTPAPIHandler(domain string, iManager integration.IntegrationManager, cManager clientapi.ClientManager,
